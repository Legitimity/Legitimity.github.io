---
layout: page
title: nanoGPT-tencentspark
description: "腾讯星火计划 2026 的 GPT 结构迭代 Speedrun 工程：从 nanoGPT GPT-2 逐步演化到约 170M 参数的 Dense Speedrun 模型。"
importance: 1
category: work
related_publications: false
github: https://github.com/Legitimity/nanoGPT-tencentspark
---
...
- <i class="fa-solid fa-diagram-project"></i> **结构主链**：从 Baseline 0 到 Dense Speedrun 的完整迭代路径
